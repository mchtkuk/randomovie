...
export default function Home() {
  ...
  const genreNames = randomMovie ? mapGenreIdsToNames(randomMovie.genre_ids) : [];
      ...
      <section className="flex flex-col gap-5 mt-10 items-center">
        <div className="flex flex-col text-center gap-2 justify-center">
          <h2 className="font-bold text-3xl">
           Cant decide to choose a movie,
          </h2>
          <h3 className="font-bold text-2xl">Press the button and generate a random movie ticket.</h3>
        </div>
        <button
