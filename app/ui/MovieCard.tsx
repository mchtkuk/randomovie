...
const MovieCard: FC<MovieCardProps> = ({ title, overview, genre_ids, vote_average, backdrop_path }) => {
  ...
  return (
    <div className="relative grid  w-full max-w-[24rem] flex-col overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
      <div
      ...
      >
        <div className="absolute inset-0  to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50 backdrop-blur-[1px]"></div>
      </div>
